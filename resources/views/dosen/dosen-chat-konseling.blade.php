...
<div class="row g-4">
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <a href="{{route('konselDos', Auth::guard('dosen')->user()->nip)}}"><button class="btn btn-primary mb-4"><i class="fa fa-arrow-left"></i> Back</button></a>
        ...
        <div class="col-12">
            <div class="rounded p-4 border">
                <nav class="navbar navbar-light px-4 py-0 rounded">
                    ...
                    <i class="fa fa-user fa-2x"><span class="h6 ms-2">{{$konseling[0]->mahasiswa->nm_mhs}}</span></i>
                ...
                @endif
                <form action="{{route('createChatDos')}}" method="POST" class="form-group mt-2">
                    @csrf
                    <input type="text" name="id_konseling" value="{{$konseling[0]->id}}" hidden>
                    <input type="text" name="flag" value="B" hidden>
